...
{
	HAL_I2C_Mem_Write(&OLED_I2C_PORT, 0x78, 0x00, I2C_MEMADD_SIZE_8BIT, &Command, 1 ,100);
}
...
{
	HAL_I2C_Mem_Write(&OLED_I2C_PORT, 0x78, 0x40, I2C_MEMADD_SIZE_8BIT, Data, Count, 100);		
}
